...
export const createMessage = async (req, res, next) => {
    ...
    try {
        const query = 'INSERT INTO message (text, person_id) values ($1, $2) RETURNING id';
...
export const getMessages = async (req, res, next) => {
    ...
    try {
        ...
        const query = 'SELECT message.id, message.text, person.id AS person_id, person.name AS person_name ' +
